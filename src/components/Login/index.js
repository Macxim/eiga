      ...
      <div className="Main-wrapper">
        ...
        <div className="Login-wrapper">
          <form className="login-form eiga-form" onSubmit={(event) => this.authWithEmailPassword(event)}>
            ...
            <span className="login-form-notice">If you don't have an account already, this form will create you one.</span>
            <div className="login-form-content">
              <label className="" htmlFor="email">
                Email
              </label>
              <input className="" id="email" name="email" type="email" ref={(input) => {this.emailInput = input}} placeholder="Email"></input>
              ...
              <div className="login-social-wrapper">
                ...
                <button className="login-social" onClick={() => this.authWithGithub()}>
                ...
                <button className="login-social" onClick={() => this.authWithTwitter()}>
                ...
                <button className="login-social" onClick={() => this.authWithGoogle()}>
